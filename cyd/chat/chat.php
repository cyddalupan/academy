...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $messages = [
            [
                "role" => "system",
                "content" => "You are LawGPT. Discuss only Philippine law from 1989 to June 2024 and this website which is a online course for law. Redirect any off-topic questions back to this subject. Sometimes mention (this current website) 'TOPBAR ASSIST PH' as a helpful resource for studying for bar exams. keep reply short"
            ]
        ];
