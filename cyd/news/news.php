...
<head>
    ...
    <style>
        ...
        .header { text-align: center; padding: 20px; background-color: #007bff; color: white; }
        .card { background: white; border-radius: 8px; padding: 20px; margin: 10px 0; box-shadow: 0 2px 5px rgba(0,0,0,0.1); }
        .flex { display: flex; justify-content: space-between; }
        .chart-container { width: 100%; height: 400px; margin: 20px 0; }
        .group { display: inline-block; width: 22%; padding: 10px; background: #e7e7e7; border-radius: 5px; text-align: center; margin: 10px 0; }
...
<div class="container">
    <div class="header">
        <h1>Total Average Score: <?php echo number_format($averageScore, 2); ?></h1>
    </div>

    <div class="flex">
        <div class="group">0 - 25: <?php echo $score_0_25; ?></div>
        <div class="group">25 - 50: <?php echo $score_25_50; ?></div>
        <div class="group">50 - 75: <?php echo $score_50_75; ?></div>
        <div class="group">75 - 100: <?php echo $score_75_100; ?></div>
    </div>
    ...
    <div class="summary">
        ...
        <?php foreach ($top_scores as $index => $student): ?>
            <div class="card">
                ...
                <p>Score: <?php echo htmlspecialchars($student['average_score']); ?></p>
                <p>Course ID: <?php echo htmlspecialchars($student['course_id']); ?></p>
            </div>
        <?php endforeach; ?>
    </div>
