...
<head>
  ...
  <title><?php echo $ebook['title'] .' | '. get_settings('system_name'); ?></title>
...
<body>
     <div id="my_pdf_viewer">
        ...
        <div id="zoom_controls">  
            ...
            <a href="<?php echo $_SERVER['HTTP_REFERER']; ?>" style="font-size: 18px; position: fixed; top: 20px; right: 20px;"><?php echo get_phrase('Back'); ?></a>
    ...
    <script>
        ...
        pdfjsLib.getDocument('<?php echo base_url("addons/ebook/view/".$ebook['ebook_id']."/pdf"); ?>').then((pdf) => {
