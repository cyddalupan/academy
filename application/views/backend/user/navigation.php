			...
			<?php if ($this->session->userdata('is_instructor')) : ?>
				...
				<?php if (addon_status('bootcamp') && $this->session->userdata('is_instructor') == 1) : ?>
			        <li class="side-nav-item <?php if ($page_name == 'bootcamp/list' || $page_name == 'bootcamp_form' || $page_name == 'bootcamp/payment_invoice') : ?> active <?php endif; ?>">
			            <a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'bootcamp/list' || $page_name == 'bootcamp_form' || $page_name == 'bootcamp/payment_invoice') : ?> active <?php endif; ?>">
			            ...
			            <ul class="side-nav-second-level" aria-expanded="false">
			                ...
			                <!-- live class -->
			                <li class="<?php if ($page_name == 'bootcamp/list') echo 'active'; ?>">
