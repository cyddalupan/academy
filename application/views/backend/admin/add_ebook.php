                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-10">
                                                ...
                                                <!-- <div class="form-group mb-3">
                                                    <label for="banner"><?php echo get_phrase('ebook_banner'); ?></label>
                                                    <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                        <div class="box" style="width: 300px;">
                                                            ...
                                                            <div class="upload-options">
                                                                ...
                                                                <input id="banner" style="visibility:hidden;" type="file" class="image-upload" name="banner"
                                                                    accept="image/*">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                        <div class="box" style="width: 300px;">
                                                            <div class="js--image-preview"
                                                                style="background-image: url('<?php echo base_url('uploads/ebook/thumbnails/placeholder.svg'); ?>'); background-color: #F5F5F5; background-size: cover; background-position: center;">
                                                            </div>
                                                            <div class="upload-options">
                                                                ...
                                                                <input id="thumbnail" style="visibility:hidden;" type="file" class="image-upload" name="thumbnail"
                                                                    accept="image/*">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" name="is_free" id="is_free" value="1"
                                                ...
                                                <div class="paid-course-stuffs">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control" id="price" name="price" placeholder="<?php echo get_phrase('enter_ebook_price'); ?>"
                                                                min="1">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="file" class="form-control" name="ebook_preview_file" id="ebook_preview_file">

                                                    </div>

                                                    <label class="col-md-2 col-form-label" for="ebook_complete_file"><?php echo get_phrase('ebook_complete_file'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="file" class="form-control" name="ebook_complete_file" id="ebook_complete_file">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="no_of_pages"
                                                            name="no_of_pages" placeholder="<?php echo get_phrase('enter_total_ebook_page_number'); ?>"
